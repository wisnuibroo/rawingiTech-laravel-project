<nav>
    ...
    <div class="bg-[#E5FFE6] shadow">
      <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div>
          <a href="#" class="text-green hover:text-green-500 font-poppins">Log in</a>
          <a href="#" class="bg-green-600 text-white px-4 py-2 rounded ml-2 hover:bg-green-700 font-poppins">Sign up</a>
        </div>
      </div>
    </div>
  </nav>
