                ...
                <form class="space-y-6" method="POST" action="/login">
                    ...
                    <div>
                        ...
                        <input type="text" id="username" name="username" placeholder="Enter your username"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-400 transition duration-200 ease-in-out" required>
                    </div>
