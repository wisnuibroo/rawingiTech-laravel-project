...
<body class="bg-gradient-to-br from-green-100 via-green-200 to-green-300 flex items-center justify-center min-h-screen">
    <div class="w-full max-w-6xl flex flex-col lg:flex-row rounded-lg shadow-lg">
        ...
        <div class="w-full lg:w-1/2 p-10">
            <div class="bg-gradient-to-tr from-white to-green-100 p-8 rounded-xl shadow-lg">
                <div class="text-center">
                    ...
                    <p class="mt-2 text-gray-600 text-sm">Create your account to join our community</p>
                </div>
        ...
        <div class="w-full lg:w-1/2 p-10 flex flex-col justify-center items-center">
            <div class="bg-gradient-to-br from-green-50 to-green-200 p-8 rounded-xl shadow-lg">
                ...
                <p class="mt-4 text-gray-700 text-center text-sm leading-relaxed">
                    Join our coding community and start your journey toward mastering new skills. Explore endless possibilities, grow your knowledge, and build your future as a developer.
                </p>
                <div class="mt-6">
                    <img src="https://imgx.parapuan.co/crop/0x213:1999x1637/500x300/filters:format(webp)/photo/2024/04/06/4672556_2451014jpg-20240406104720.jpg" 
                        alt="Coding Illustration" class="rounded-lg shadow-md w-full">
                </div>
            </div>
        </div>
    </div>
