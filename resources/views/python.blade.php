        ...
        <div class="bg-white shadow-lg rounded-lg p-6 flex w-full h-5/6">
            ...
            <div class="w-2/3 bg-[#C9F5D9] rounded-lg p-6 ml-6">
                ...
                <p class="text-gray-700 mb-4">
                    Python is a versatile and powerful programming language that helps you create game and programs that can run on various devices, such as computers, mobile phones, and even TVs. It is designed to be simple, secure, and easy to use, allowing you to write a program once and run it anywhere.
                </p>
                <p class="text-gray-700 mb-4">
                    In this class, you will learn the basics of Python programming, including how to write, debug, and execute your first programs. You will also explore key concepts such as variables, loops, and object-oriented programming, which form the foundation of creating real-world applications.
                </p>
                <p class="text-gray-700 mb-6">
                    In this class, you will get to know and learn the basics of the Python programming language.
                </p>
